        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal" action="<?php echo e(route('store')); ?>" method="post" id="ajax-upload">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('category')); ?>" id="category" placeholder="Enter Quantity" name="category">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\AnasAcademy\resources\views/create_product.blade.php ENDPATH**/ ?>